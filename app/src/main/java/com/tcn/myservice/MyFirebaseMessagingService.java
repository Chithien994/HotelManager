...
import com.tcn.hotelmanager.LoginActivity;
import com.tcn.hotelmanager.R;
import com.tcn.hotelmanager.RoomActivity;


/**
 * Created by MyPC on 25/12/2017.
 */
    ...
    private void sendNotification(String messageBody) {
        ...
        NotificationCompat.Builder notificationBuilder =
                new NotificationCompat.Builder(this, channelId)
                        ...
                        .setBadgeIconType(R.drawable.ic_msg)
                        .setSmallIcon(R.drawable.ic_msg)
                        .setLargeIcon(BitmapFactory.decodeResource(getResources(), R.mipmap.ic_launcher))
                        .setContentText(messageBody)
                        .setColor(getResources().getColor(R.color.colorAppBar))
                        .setAutoCancel(true)
